...
those two settings belong in every onboarding document TestLens ever ships.
...
key, or password in it leaves TestLens. The response may quote evidence back —
...
the ZIP reaches TestLens, not the safety or analysis rules applied after it
arrives.
